...
class CvCreation():
    ...
    def __init__(self):
        ...
        self.nprate, self.rprate, self.dprate = self.covobject.load_positive_df()
    ...
    def cv_load(self, **kwargs):
        ...
        cv = dict(
            ...
            map_positive_reg = self.covobject.map_positive_reg(),
            map_positive_dep = self.covobject.map_positive_dep(),
            charts_impacted_dep = self.covobject.charts_impacted_dep(),
            charts_and_parameters_positive_data = self.covobject.charts_and_parameters_positive_data(),
